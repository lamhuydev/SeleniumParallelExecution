...
//        wait.until(ExpectedConditions.titleIs(titleExpected));
        Assert.assertEquals(DriverManager.getDriver().getTitle(), titleExpected, "Title page is not correct");
        Assert.assertEquals(WebUI.getText(headerCustomerPage), "Customers Summary", "CustomerPage: header page is not correct");
...
//        addButton.click();
        ...
        WebUI.waitForElementClickable(buttonAddNewCustomer);
    ...
    public void submitDataForNewCustomer() {
        ...
        WebUI.setText(inputCompany, excelHelper.getCellData("Customer_Name", row_excel_data));

        WebUI.setText(inputVAT, excelHelper.getCellData("VAT", row_excel_data));

        WebUI.setText(inputPhoneNumber, excelHelper.getCellData("Phone", row_excel_data));
        WebUI.setText(inputWebsite,  excelHelper.getCellData("Website", row_excel_data));
    ...
    public void verifyAddNewCustomerSuccess(String customerName) {
        ...
        Assert.assertEquals(DriverManager.getDriver().findElement(inputCompany).getAttribute("value"), customerName, "CustomerPage: Customer name not match with detail customer");
        Assert.assertEquals(DriverManager.getDriver().findElement(inputVAT).getAttribute("value"), excelHelper.getCellData("VAT", row_excel_data), "CustomerPage: VAT not match");
        Assert.assertEquals(DriverManager.getDriver().findElement(inputPhoneNumber).getAttribute("value"), excelHelper.getCellData("Phone", row_excel_data), "CustomerPage: Phone number not match");
        Assert.assertEquals(DriverManager.getDriver().findElement(inputWebsite).getAttribute("value"), excelHelper.getCellData("Website", row_excel_data), "CustomerPage: Website input not match");
        Assert.assertEquals(DriverManager.getDriver().findElement(buttonDropdownGroup).getAttribute("title"), "VIP", "CustomerPage: Groups not match");
        Assert.assertEquals(DriverManager.getDriver().findElement(dropdownLanguage).getAttribute("title"), "Vietnamese", "CustomerPage: Language not match");
